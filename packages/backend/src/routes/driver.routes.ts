    ...
    try {
      ...
      for (const packageId of packageIds) {
        ...
        if (pkg) {
          ...
          packages.push({
            ...
            destinationLatitude: pkg.destinationLatitude ? Number(pkg.destinationLatitude) : null,
            destinationLongitude: pkg.destinationLongitude ? Number(pkg.destinationLongitude) : null,
      ...
      sendSuccess(response, {
        ...
        stops: routeDetails.stops.map((s) => ({
          ...
          depotAddress: '',
          latitude: s.depotLatitude ?? null,
          longitude: s.depotLongitude ?? null,
